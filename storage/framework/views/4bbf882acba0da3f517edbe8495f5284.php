  ...
  <header class="bg-white shadow-sm no-print">
   ...
   <div class="print-header hidden bg-white py-4 border-b-2 border-blue-600">
    <div class="text-center">
      ...
      <p class="text-md font-medium text-blue-600"><?php echo e($month); ?></p>
    </div>
  </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr class="hover:bg-gray-50">
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700 text-center"><?php echo e($index + 1); ?></td>
                <td class="px-4 py-3 whitespace-nowrap">
                  <div class="text-sm font-medium text-gray-900"><?php echo e($attendance->user->name); ?></div>
                </td>
                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-700">
                  <?php echo e($attendance->scan_time->format('d-m-Y')); ?>
        ...
        <div class="mt-6 p-4 bg-gray-50 rounded-lg">
          <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="text-sm text-gray-600">
              Total Kehadiran Guru: <span class="font-semibold"><?php echo e($attendances->count()); ?> data</span>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\hadirin5\resources\views/prints/print-bulanan.blade.php ENDPATH**/ ?>