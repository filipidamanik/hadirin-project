...
<body class="bg-gray-50 text-gray-800 font-sans min-h-screen antialiased">
  ...
  <header class="w-full header-height rounded-b-3xl bg-gradient-to-br from-primary-800 to-primary-900 px-6 py-8 md:px-8 md:py-10 relative overflow-hidden">
    ...
    <div class="text-white text-center mt-6 md:mt-8">
      <div class="mx-auto w-20 h-20 md:w-24 md:h-24">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo SMKN 1 Kota Bengkulu" class="w-full h-full object-contain" />
      </div>
  ...
  <main class="px-4 py-6 md:px-8 md:py-10 max-w-6xl mx-auto transition-all duration-300">
    ...
    <div id="tab1" class="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 transition-opacity duration-300">
      ...
      <!-- Card 3 -->
      <a href="<?php echo e(route('generate.id.show')); ?>" class="card-square bg-white rounded-xl shadow-card hover:shadow-card-hover hover:scale-[1.02] transition-all duration-200 group overflow-hidden border border-gray-100 animate-fade-in animate-slide-up">
        <div class="h-full p-4 md:p-6 flex flex-col">
          <div class="w-10 h-10 md:w-14 md:h-14 rounded-lg bg-blue-50 mb-3 md:mb-4 flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200 mx-auto">
      ...
      <!-- Card 4 -->
      <a href="<?php echo e(route('scan.show')); ?>" class="card-square bg-white rounded-xl shadow-card hover:shadow-card-hover hover:scale-[1.02] transition-all duration-200 group overflow-hidden border border-gray-100 animate-fade-in animate-slide-up">
        <div class="h-full p-4 md:p-6 flex flex-col">
          <div class="w-10 h-10 md:w-14 md:h-14 rounded-lg bg-blue-50 mb-3 md:mb-4 flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200 mx-auto">
...
<div id="tab2" class="hidden grid grid-cols-1 gap-3 sm:gap-4 md:gap-6 transition-opacity duration-300">
  ...
  <a href="<?php echo e(route('print.harian')); ?>" class="bg-white rounded-xl shadow-card hover:shadow-card-hover hover:scale-[1.02] transition-all duration-200 group overflow-hidden border border-gray-100 animate-fade-in animate-slide-up">
  ...
  <div class="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
    <!-- Square Card 1 -->
    <a href="<?php echo e(route('print.bulanan')); ?>" class="card-square bg-white rounded-xl shadow-card hover:shadow-card-hover hover:scale-[1.02] transition-all duration-200 group overflow-hidden border border-gray-100 animate-fade-in animate-slide-up">
      <div class="h-full p-4 md:p-6 flex flex-col">
        <div class="w-10 h-10 md:w-14 md:h-14 rounded-lg bg-blue-50 mb-3 md:mb-4 flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200 mx-auto">
          <i data-feather="calendar" class="w-6 h-6 md:w-8 md:h-8 text-blue-800"></i>
        </div>
    ...
    <!-- Square Card 2 -->
    <a href="<?php echo e(route('print.card.id')); ?>" class="card-square bg-white rounded-xl shadow-card hover:shadow-card-hover hover:scale-[1.02] transition-all duration-200 group overflow-hidden border border-gray-100 animate-fade-in animate-slide-up">
      <div class="h-full p-4 md:p-6 flex flex-col">
        <div class="w-10 h-10 md:w-14 md:h-14 rounded-lg bg-blue-50 mb-3 md:mb-4 flex items-center justify-center group-hover:bg-blue-100 transition-colors duration-200 mx-auto">
...
</html><?php /**PATH C:\xampp\htdocs\hadirin5\resources\views/welcome.blade.php ENDPATH**/ ?>